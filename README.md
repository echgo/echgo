...
Currently you can store the following channels in the file, if they are configured: **gotify, matrix, telegram, discord, trello, zendesk, osticket, smtp & webhook**.
