...
func Execute(headline, message string) {
	...
	lookup := environment2.Lookup("MATRIX_BASE_URL", "MATRIX_ROOM_ID", "MATRIX_ACCESS_TOKEN")
	if lookup {

		r := Request{
			BaseUrl:     environment2.String("MATRIX_BASE_URL"),
			RoomId:      environment2.String("MATRIX_ROOM_ID"),
			AccessToken: environment2.String("MATRIX_ACCESS_TOKEN"),
		}
