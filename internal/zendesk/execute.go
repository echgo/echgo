...
func Execute(headline, message string) {
	...
	lookup := environment2.Lookup("ZENDESK_BASE_URL", "ZENDESK_USERNAME", "ZENDESK_API_TOKEN")
	if lookup {

		r := Request{
			BaseUrl:  environment2.String("ZENDESK_BASE_URL"),
			Username: environment2.String("ZENDESK_USERNAME"),
			ApiToken: environment2.String("ZENDESK_API_TOKEN"),
		}
